        ...
        return AlbianClassScanner.filter(AlbianClassLoader.getInstance(),
                ...
                new IAlbianClassExcavator() {
                    ...
                    public Object finder(Class<?> clzz) {
                        ...
                        AlbianServiceRant rant = clzz.getAnnotation(AlbianServiceRant.class);
                        asa.setId(rant.Id());
                        ...
                        asa.setType(clzz.getName());
                        asa.setServiceClass(clzz.asSubclass(IAlbianService.class));

                        if(clzz.isAnnotationPresent(AlbianServiceProxyRants.class)){
                            AlbianServiceProxyRants prants = clzz.getAnnotation(AlbianServiceProxyRants.class);
                        ...
                        Map<String,IAlbianServiceFieldAttribute> fields = scanFields(clzz);
