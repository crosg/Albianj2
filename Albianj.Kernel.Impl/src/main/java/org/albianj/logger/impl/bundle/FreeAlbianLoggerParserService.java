...
public class FreeAlbianLoggerParserService extends FreeAlbianParserService {
    protected String logPathInWin = "c:\\logs\\";
    protected String logPathInLinux = "/data/logs/JAVA/";

    protected AlbianBundleModuleKeyValueConf parserLoggers(String filename, AlbianBootAttribute bootAttr, Element node) {
    ...
    protected IAlbianBundleLoggerAttribute parserLoggerOrGetDefault(String filename, AlbianBootAttribute bootAttr, Element node){
