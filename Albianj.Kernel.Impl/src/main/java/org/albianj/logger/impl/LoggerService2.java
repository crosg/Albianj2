 ...
 */
@CommentsTag("新的logger日志类，解决log-v1中无法正确标识文件位置问题")
@ServiceTag(Id = ILoggerService2.Name, Interface = ILoggerService2.class)
public class LoggerService2 extends FreeService implements
        ILoggerService2 {
