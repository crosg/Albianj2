...
import org.albianj.logger.impl.bundle.FreeAlbianLoggerParserService;
 ...
 */
public class AlbianBootParserService extends FreeAlbianLoggerParserService {
    private String file = "boot.xml";

    private String[] defLogs = {
            IAlbianBundleLoggerService.LogName4Runtime,
            IAlbianBundleLoggerService.LogName4State,
            IAlbianBundleLoggerService.LogName4Monitor
    };
    ...
    private void parser(String bootXmlFilePath,Document bootXml,AlbianBootAttribute bootAttr,String bundleName ) {
        ...
        if(Validate.isNullOrEmptyOrAllSpace(sMid)) {
            AlbianBundleContext bundleContext = AlbianBootContext.Instance.findBundleContext(bundleName,true);
    ...
    private AlbianBundleModuleKeyValueConf checkAndMakeupDefault(AlbianBootAttribute bootAttr, AlbianBundleModuleKeyValueConf map) {
