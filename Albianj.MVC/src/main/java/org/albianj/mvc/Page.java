...
public class Page {
	...
	@HttpActionAttribute(Name = "PageLoad")
	public void pageload(HttpContext ctx){
		this.load(ctx);
	}

	protected void load(HttpContext ctx){
	...
	public void addScriptBlock( String script ) {
		addScript( new StringBuffer( ).append( "<script language='javascript'>" ).append( script )
		                .append( "</script>" ).toString( ) );
	}

	public List< String > getBlockScript( ) {
		return scripts;
	}
