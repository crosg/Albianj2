...
public class AlbianExceptionServant {
    ...
    public StringBuilder makeCauseChainBuffer(Throwable e){
        ...
        causeStack.push(rc); // push first cause
        while(null != (ptr = rc.getCause())  && (rc != ptr) ) {
            causeStack.push(ptr); // push cause chain
            rc = ptr;
        }
    ...
    public void throwExterException(int code, Class<?> local,Throwable cause, String brief, String fmt,Object...obj) {
        String msg = AlbianStringServant.Instance.format(fmt,obj);
        if(null == cause){
            throw new AlbianExterException(code,local,brief,msg);
        }
        throw new AlbianExterException(code,local,cause,brief,msg);
    }

    public void throwInterException(int code, Class<?> local,Throwable cause, String brief, String secretMsg,String fmt,Object... obj) {
        String msg = AlbianStringServant.Instance.format(fmt,obj);
        if(null == cause){
            throw new AlbianInterException(code,local,brief,secretMsg,msg);
        }
        throw new AlbianInterException(code,local,cause,brief,secretMsg,msg);
    }
