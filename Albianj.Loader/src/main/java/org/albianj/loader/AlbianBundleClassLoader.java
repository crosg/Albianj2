...
import org.albianj.loader.helpers.AlbianClassServant;
import org.albianj.loader.helpers.AlbianFileServant;
import org.albianj.loader.rant.AlbianBundleSharingTag;
...
public class AlbianBundleClassLoader extends ClassLoader {
    ...
    protected Class<?> findClass(String name) throws ClassNotFoundException {
        ...
        if (clzz != null) { //reload class by custom loader
            if (clzz.isAnnotationPresent(AlbianBundleSharingTag.class)) {
                return clzz;
            }
            ...
            if (null != itfs) {
                for (Class<?> itf : itfs) {
                    ...
                    if (itf.isAnnotationPresent(AlbianBundleSharingTag.class)) {
                        return clzz;
                    }
                }
            }
