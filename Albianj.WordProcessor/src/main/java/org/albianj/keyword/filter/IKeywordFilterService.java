 ...
 */
@CommentsTag("关键字过滤service接口")
public interface IKeywordFilterService extends IParserService {

    @CommentsTag("AlbianKeywordFilterService在service.xml中的id")
     ...
     * @version 1.0
     */
    @CommentsTag("判断是否存在敏感字符")
    public boolean isContaintKeyWord(@CommentsTag("需要判断的字符串") String txt, @CommentsTag("匹配规则") int matchType);
     ...
     * @version 1.0
     */
    @CommentsTag("获取存在的敏感字符")
    public Set<String> getKeyWord(@CommentsTag("需要判断的字符串") String txt, @CommentsTag("匹配规则") int matchType);
