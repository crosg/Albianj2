...
import org.albianj.mvc.service.impl.FileUploadService;
...
@ServiceTag(Id = IMVCConfigurtionService.Name, Interface = IMVCConfigurtionService.class)
public class MVCConfigurtionService extends FreeParserService implements IMVCConfigurtionService {
    ...
    public void parserFile(AlbianHttpConfigurtion c, String filename){
        ...
        if(null == elt){
            ...
            fuc.setFileUploadServiceClass(FileUploadService.class);
        } else {
        ...
        if(null == elt){
            ...
            if(Validate.isNullOrEmptyOrAllSpace(classname)){
                ...
                try {
                    ...
                    AlbianServiceRouter.getLogger2().log(ILoggerService2.AlbianRunningLoggerName,
                            ILoggerService2.InnerThreadName,AlbianLoggerLevel.Warn,e,
