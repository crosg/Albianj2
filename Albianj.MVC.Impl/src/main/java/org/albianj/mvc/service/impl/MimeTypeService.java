...
import org.albianj.mvc.service.IMimeTypeService;
 ...
 */
@ServiceTag(Id = IMimeTypeService.Name, Interface = IMimeTypeService.class)
public class MimeTypeService extends FreeParserService implements IMimeTypeService {
