...
@ServiceTag(Id = IFileUploadService.Name, Interface = IFileUploadService.class)
public class FileUploadService extends FreeService implements IFileUploadService {
