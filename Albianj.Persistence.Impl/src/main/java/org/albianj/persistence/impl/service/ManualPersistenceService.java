...
import org.albianj.persistence.service.IManualPersistenceService;
 ...
 */
@ServiceTag(Id = IManualPersistenceService.Name, Interface = IManualPersistenceService.class)
public class ManualPersistenceService extends FreeService implements IManualPersistenceService {
