...
public abstract class FreeDataBasePool implements IDataBasePool {
    ...
    protected DataSource getDatasource(final String key, IRunningStorageAttribute rsa,String server,int port) {
        ...
        synchronized (_dataSource) {
            ...
            if (ds == null) {
                ...
                ds = setupDataSource(key, rsa,server,port);
    ...
    protected abstract DataSource setupDataSource(final String key, final IRunningStorageAttribute rsa,String server,int port);
