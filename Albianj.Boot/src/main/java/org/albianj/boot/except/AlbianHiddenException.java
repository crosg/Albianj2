 ...
 */
public class AlbianHiddenException extends AlbianDisplayException {
     ...
     */
    public AlbianHiddenException(int code, Class<?> local, String brief, String hideMsg, String showMsg) {
     ...
     */
    public AlbianHiddenException(int code, Class<?> local, Throwable interThrow, String brief, String hideMsg, String showMsg) {
    ...
    public String getLocalizedMessage() {
        return AlbianExceptionServant.Instance.makeMessage(this.brief, this.showMsg, this, this.interThrow).toString();
    }

    public String getMessageWithHide() {
        return AlbianExceptionServant.Instance.makeMessage(this.brief, this.showMsg, this.hideMsg, this, this.interThrow).toString();
    }
}
