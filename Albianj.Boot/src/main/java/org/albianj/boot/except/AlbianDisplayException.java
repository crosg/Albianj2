 ...
 */
public class AlbianDisplayException extends RuntimeException {
    ...
    protected int code = AlbianExceptionServant.Code.Normal;
     ...
     */
    public AlbianDisplayException(int code, Class<?> local, String brief, String showMsg) {
     ...
     */
    public AlbianDisplayException(int code, Class<?> local, Throwable interThrow, String brief, String showMsg) {
        this.brief = brief;
